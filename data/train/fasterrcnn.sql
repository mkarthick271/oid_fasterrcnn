...
COPY ctrnimglabel (imageid, source, labelname, confidence) FROM '/home/mkarthick2714/train/challenge-2019-train-detection-human-imagelabels.csv' DELIMITER ',' CSV HEADER;
COPY ctrnimgbbox (imageid, source, labelname, confidence, xmin1, xmax1, ymin1, ymax1, isoccluded, istruncated, isgroupof, isdepiction, isinside) FROM '/home/mkarthick2714/train/challenge-2019-train-detection-bbox.csv' DELIMITER ',' CSV HEADER;
...
COPY labeldesc (labelname, labeldesc) FROM '/home/mkarthick2714/train/challenge-2019-classes-description-500.csv' DELIMITER ',' CSV HEADER;
